          ...
          {achievements.map((achievement, index) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 border-2 border-neon-yellow neon-border flex items-start gap-4 hover:border-neon-pink hover:shadow-[0_0_30px_rgba(255,113,206,0.3)] transition-all group interactive"
              >
